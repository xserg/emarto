                        ...
                        <?php foreach ($product_images as $image): ?>
                            <div class="item">
                                <div class="item-inner">
                                    ...
                                    <img src="<?php echo IMG_BASE64_1x1; ?>" data-lazy="<?php echo get_product_image_url($image, 'image_small'); ?>" class="img-thumbnail" alt="<?php echo get_product_title($product_details); ?>">
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                        ...
                        foreach ($product_images as $image): ?>
                            <div class="item">
                                <a href="<?php echo get_product_image_url($image, 'image_big'); ?>" title="">
                                    ...
                                    <img src="<?php echo IMG_BASE64_1x1; ?>" data-lazy="<?php echo get_product_image_url($image, 'image_default'); ?>" alt="<?php echo get_product_title($product_details); ?>" class="img-product-slider">
                                </a>
                            </div>
                        <?php endforeach;
                    else: ?>
