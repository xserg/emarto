                                ...
                                <div class="modal-body">
                                    <div class="form-group m-b-10">
                                        ...
                                        <?php //foreach ($this->languages as $language): ?>
                                            <input type="text" name="method_name_<?= $option_unique_id; ?>_lang_1" class="form-control form-input m-b-5" value="<?= $selected_option; ?>" placeholder="<?= $language->name; ?>" maxlength="255">
                                        <?php //endforeach; ?>
                                    </div>
