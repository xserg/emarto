...
<div class="row">
    <div class="col-sm-12">
        <div class="box box-add-product">
            <div class="box-body">
                ...
                <?php echo form_open('add-product-post', ['id' => 'form_validate', 'class' => 'validate_price', 'onkeypress' => "return event.keyCode != 13;"]); ?>
                ...
                <input type="hidden" name="copy_id" value="<?php echo $product->id; ?>">
    ...
    <div class="col-sm-12">
        ...
        <button type="submit" class="btn btn-lg btn-success pull-right m-r-10"><?php echo trans("save_and_continue"); ?></button>
