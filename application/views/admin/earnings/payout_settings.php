...
<div class="row">
    ...
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open('earnings_controller/payout_bitcoin_settings_post'); ?>
            <div class="box-body">
                <!-- include message block -->
                <?php if (!empty($this->session->flashdata("msg_bitcoin"))):
                    $this->load->view('admin/includes/_messages');
                endif; ?>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="payout_bitcoin_enabled" value="1" id="bitcoin_enabled_1"
                                   class="square-purple" <?php echo ($this->payment_settings->payout_bitcoin_enabled == 1) ? 'checked' : ''; ?>>
                            <label for="bitcoin_enabled_1" class="option-label"><?php echo trans('enable'); ?></label>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="payout_bitcoin_enabled" value="0" id="bitcoin_enabled_2"
                                   class="square-purple" <?php echo ($this->payment_settings->payout_bitcoin_enabled != 1) ? 'checked' : ''; ?>>
                            <label for="bitcoin_enabled_2" class="option-label"><?php echo trans('disable'); ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label"><?php echo trans('min_poyout_amount'); ?> (<?= $this->default_currency->symbol; ?>)</label>
                    <input type="text" name="min_payout_bitcoin" class="form-control form-input price-input" value="<?php echo get_price($this->payment_settings->min_payout_bitcoin, 'input'); ?>" onpaste="return false;" maxlength="32" required>
                </div>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo trans('payoneer'); ?></h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open('earnings_controller/payout_payoneer_settings_post'); ?>
            <div class="box-body">
                <!-- include message block -->
                <?php if (!empty($this->session->flashdata("msg_payoneer"))):
                    $this->load->view('admin/includes/_messages');
                endif; ?>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="payout_payoneer_enabled" value="1" id="payoneer_enabled_1"
                                   class="square-purple" <?php echo ($this->payment_settings->payout_payoneer_enabled == 1) ? 'checked' : ''; ?>>
                            <label for="payoneer_enabled_1" class="option-label"><?php echo trans('enable'); ?></label>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="payout_payoneer_enabled" value="0" id="payoneer_enabled_2"
                                   class="square-purple" <?php echo ($this->payment_settings->payout_payoneer_enabled != 1) ? 'checked' : ''; ?>>
                            <label for="payoneer_enabled_2" class="option-label"><?php echo trans('disable'); ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label"><?php echo trans('min_poyout_amount'); ?> (<?= $this->default_currency->symbol; ?>)</label>
                    <input type="text" name="min_payout_payoneer" class="form-control form-input price-input" value="<?php echo get_price($this->payment_settings->min_payout_payoneer, 'input'); ?>" onpaste="return false;" maxlength="32" required>
                </div>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
